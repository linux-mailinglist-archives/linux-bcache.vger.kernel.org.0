Return-Path: <linux-bcache+bounces-390-lists+linux-bcache=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-bcache@lfdr.de
Delivered-To: lists+linux-bcache@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id F074089CC5B
	for <lists+linux-bcache@lfdr.de>; Mon,  8 Apr 2024 21:23:17 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id A900C2868B7
	for <lists+linux-bcache@lfdr.de>; Mon,  8 Apr 2024 19:23:16 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 553F81442F6;
	Mon,  8 Apr 2024 19:23:14 +0000 (UTC)
X-Original-To: linux-bcache@vger.kernel.org
Received: from mx.ewheeler.net (mx.ewheeler.net [173.205.220.69])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E9EDC1448E2
	for <linux-bcache@vger.kernel.org>; Mon,  8 Apr 2024 19:23:11 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=173.205.220.69
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712604194; cv=none; b=Gct57Sg/ug/GbiFbn8ro+Q9snV+4o21SUUIM413jXNFfefrspE4SmqvE/AkpQFdg0M7lGAbHhDhUL+RX1wlpVK/u6LtLfgjKl45xD8eHeV74vFVigzWbEUuHRuhlLE71VjgiOiyXE4VqJ0nUh4EGywTdcKCAyMy/sCj8Evt7jfI=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712604194; c=relaxed/simple;
	bh=Dga3h+Avgz7AkW1BYCcNUJ6rxRUUniClkYEaipbPEIw=;
	h=Date:From:To:cc:Subject:In-Reply-To:Message-ID:References:
	 MIME-Version:Content-Type; b=ZdThiMqVLMnekVtntRBXoUOEdAlGMupgDK6nR77Mrrbkb3zU4e8zBleVe8C81clPFxAaTNNIZwwJN1IUErH1gLa6VgCOmiXryU8f4xyCmS5JPvyhpJY1/gQQ8lVYPC3xJqpRuBYiU2z0bF/GFFN2Iy8pPZbmAd5htHqy6lgHyiE=
...
Received: from localhost (localhost [127.0.0.1])
	by mx.ewheeler.net (Postfix) with ESMTP id D40B285;
	Mon,  8 Apr 2024 12:23:10 -0700 (PDT)
X-Virus-Scanned: amavisd-new at ewheeler.net
Received: from mx.ewheeler.net ([127.0.0.1])
	by localhost (mx.ewheeler.net [127.0.0.1]) (amavisd-new, port 10024)
	with LMTP id nmXQtuX89E0X; Mon,  8 Apr 2024 12:23:06 -0700 (PDT)
Received: from localhost (localhost [127.0.0.1])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by mx.ewheeler.net (Postfix) with ESMTPSA id 4A62640;
	Mon,  8 Apr 2024 12:23:06 -0700 (PDT)
DKIM-Filter: OpenDKIM Filter v2.11.0 mx.ewheeler.net 4A62640
Date: Mon, 8 Apr 2024 12:23:06 -0700 (PDT)
...
In-Reply-To: <vrtjbtapbjnlfg6atapeueugaqpkuv3ksa7l3upqv2k2zmxniu@ffawr6jo47cx>
Message-ID: <d15ba130-f5c-96e7-e031-dccc5e725656@ewheeler.net>
References: <f11efb2e-824-c934-1d68-91a09dcb2dbd@ewheeler.net> <vrtjbtapbjnlfg6atapeueugaqpkuv3ksa7l3upqv2k2zmxniu@ffawr6jo47cx>
Precedence: bulk
...
On Mon, 8 Apr 2024, Coly Li wrote:
...
> discussed this series. 

Fun!

> I mentioned the counter related stuffs should be improved, and I also 
> suggest to use it in product environment to see whether real performance 
> gain can be obviously observed.
> 
...
Ok thanks for explaining, I understand.
...
I've not tried the patch series because I was waiting for list feedback 
before trying it out. It wasn't performance that caught my eye: While 
performance may be a side-effect, I was interested in these for the 
following reasons:

* bcache: only copy dirty data during moving gc	

	For those who burn through the TBW/DWPD disks writes quickly, 
	reducing write cycles is a win because it saves people on real 
	hardware costs, plus the value of reduced environmental impact due 
	to failed/worn out SSDs.  Mingzhe wrote:
...
* bcache: the gc_sectors_used size matches the bucket size

	If I understand correctly, this looks like a good sanity check, 
	and maybe it should cc stable@?

* bcache: Separate bch_moving_gc() from bch_btree_gc()

	Latency is critical for most applications using bcache, and this 
	prevents IO request blocking unless the fragments reach a 
	threshold.
