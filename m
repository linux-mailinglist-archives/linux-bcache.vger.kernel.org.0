...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id A8C89119400
	for <lists+linux-bcache@lfdr.de>; Tue, 10 Dec 2019 22:15:28 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728993AbfLJVMb (ORCPT <rfc822;lists+linux-bcache@lfdr.de>);
        Tue, 10 Dec 2019 16:12:31 -0500
Received: from mail.kernel.org ([198.145.29.99]:36606 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1728982AbfLJVMa (ORCPT <rfc822;linux-bcache@vger.kernel.org>);
        Tue, 10 Dec 2019 16:12:30 -0500
Received: from sasha-vm.mshome.net (c-73-47-72-35.hsd1.nh.comcast.net [73.47.72.35])
        (using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id A1734206EC;
        Tue, 10 Dec 2019 21:12:28 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1576012349;
        bh=RflEyOd9W9raPwdc4maUJv1kkKNGsiq51a+yvRzHZik=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=iOZNWO2nkeCJKxK7h+WS0FAT7ifmMv40hDGHIiUrNpemuG/qSgXnhYN28PxGSW9qa
         totIa+ZJFc+LWmhqUQRVAQCrusMGEvHJoy6l5P+Gida364LaiWeRgtYj0AWsh1HXAm
         PrCjgIvEmyx7/GDT0VONvzJaqLwS7Vt/9NHzp6Yk=
From:   Sasha Levin <sashal@kernel.org>
To:     linux-kernel@vger.kernel.org, stable@vger.kernel.org
Cc:     Coly Li <colyli@suse.de>, Dan Carpenter <dan.carpenter@oracle.com>,
        Jens Axboe <axboe@kernel.dk>, Sasha Levin <sashal@kernel.org>,
        linux-bcache@vger.kernel.org
Subject: [PATCH AUTOSEL 5.4 279/350] bcache: fix static checker warning in bcache_device_free()
Date:   Tue, 10 Dec 2019 16:06:24 -0500
Message-Id: <20191210210735.9077-240-sashal@kernel.org>
