...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 6AF9B2C71E9
	for <lists+linux-bcache@lfdr.de>; Sat, 28 Nov 2020 23:05:34 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730488AbgK1Vu2 (ORCPT <rfc822;lists+linux-bcache@lfdr.de>);
        Sat, 28 Nov 2020 16:50:28 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:41210 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1730822AbgK1Spj (ORCPT
        <rfc822;linux-bcache@vger.kernel.org>);
        Sat, 28 Nov 2020 13:45:39 -0500
Received: from casper.infradead.org (casper.infradead.org [IPv6:2001:8b0:10b:1236::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 2F0AFC02548A;
        Sat, 28 Nov 2020 08:16:07 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
        d=infradead.org; s=casper.20170209; h=Content-Transfer-Encoding:MIME-Version:
        References:In-Reply-To:Message-Id:Date:Subject:Cc:To:From:Sender:Reply-To:
        Content-Type:Content-ID:Content-Description;
        bh=aMlU8LlM3avtbuzcK+0CGyZ+NpcwtvQFJKmMqZJvwmo=; b=I+HaCDdx3k5wJ87krYc7EC07PB
        ;
Received: from [2001:4bb8:18c:1dd6:48f3:741a:602e:7fdd] (helo=localhost)
        by casper.infradead.org with esmtpsa (Exim 4.92.3 #3 (Red Hat Linux))
        id 1kj2t8-0000KW-07; Sat, 28 Nov 2020 16:15:54 +0000
...
Cc:     Tejun Heo <tj@kernel.org>, Josef Bacik <josef@toxicpanda.com>,
        ...
        linux-mm@kvack.org
Subject: [PATCH 25/45] block: simplify bdev/disk lookup in blkdev_get
Date:   Sat, 28 Nov 2020 17:14:50 +0100
Message-Id: <20201128161510.347752-26-hch@lst.de>
