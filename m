...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id DF2DE2C54DA
	for <lists+linux-bcache@lfdr.de>; Thu, 26 Nov 2020 14:09:35 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2389998AbgKZNHc (ORCPT <rfc822;lists+linux-bcache@lfdr.de>);
        Thu, 26 Nov 2020 08:07:32 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:53150 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S2389989AbgKZNHY (ORCPT
        <rfc822;linux-bcache@vger.kernel.org>);
        Thu, 26 Nov 2020 08:07:24 -0500
Received: from casper.infradead.org (casper.infradead.org [IPv6:2001:8b0:10b:1236::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 78BFFC0617A7;
        Thu, 26 Nov 2020 05:07:24 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
        d=infradead.org; s=casper.20170209; h=Content-Transfer-Encoding:MIME-Version:
        References:In-Reply-To:Message-Id:Date:Subject:Cc:To:From:Sender:Reply-To:
        Content-Type:Content-ID:Content-Description;
        bh=FD2AUpgZKduS2hXetPTu7TbxpOwDIaKHbRNx+Oy1KRo=; b=t0E/ZjWH+lS7/pbdJ/d1dlTcUU
        ;
Received: from [2001:4bb8:18c:1dd6:27b8:b8a1:c13e:ceb1] (helo=localhost)
        by casper.infradead.org with esmtpsa (Exim 4.92.3 #3 (Red Hat Linux))
        id 1kiGzS-00044x-4z; Thu, 26 Nov 2020 13:07:14 +0000
...
Date:   Thu, 26 Nov 2020 14:04:07 +0100
Message-Id: <20201126130422.92945-30-hch@lst.de>
...
@@ -1301,8 +1237,6 @@ int bdev_disk_changed(struct block_device *bdev, bool invalidate)
...
-
 	if (get_capacity(disk)) {
 		...
 		if (ret == -EAGAIN)
@@ -1345,10 +1279,8 @@ static int __blkdev_get(struct block_device *bdev, fmode_t mode)
 			if (disk->fops->open)
...
@@ -1376,13 +1308,12 @@ static int __blkdev_get(struct block_device *bdev, fmode_t mode)
