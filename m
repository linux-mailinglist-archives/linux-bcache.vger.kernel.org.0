...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 45C9E131122
	for <lists+linux-bcache@lfdr.de>; Mon,  6 Jan 2020 12:05:02 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726383AbgAFLFA (ORCPT <rfc822;lists+linux-bcache@lfdr.de>);
        Mon, 6 Jan 2020 06:05:00 -0500
Received: from mx2.suse.de ([195.135.220.15]:40934 "EHLO mx2.suse.de"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726212AbgAFLE6 (ORCPT <rfc822;linux-bcache@vger.kernel.org>);
        Mon, 6 Jan 2020 06:04:58 -0500
X-Virus-Scanned: by amavisd-new at test-mx.suse.de
Received: from relay2.suse.de (unknown [195.135.220.254])
        by mx2.suse.de (Postfix) with ESMTP id E9A16AD82;
        Mon,  6 Jan 2020 11:04:55 +0000 (UTC)
Subject: Re: Can't mount an encrypted backing device
To:     clodoaldo.pinto.neto@gmail.com, linux-bcache@vger.kernel.org
...
Message-ID: <65c05b80-679b-2ccb-1bd1-a9a6887c9c51@suse.de>
Date:   Mon, 6 Jan 2020 19:04:47 +0800
...
On 2020/1/6 6:14 上午, Clodoaldo Neto wrote:
...
formated as bcache backing device, because crypto_LUKS super block is 4K
later (bcache offset all I/Os on bcache device 4KB behind the requesting
LBA on backing disk).

Therefore you have to mount the file system from bcache device, that is
/dev/bcache0 in your case. If you want to mount from
/dev/mapper/backing-device, it might work if you may specify the actual
file system offset is 4KB behind its original offset.
