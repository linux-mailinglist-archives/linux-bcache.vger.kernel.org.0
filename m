...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 0F440561354
	for <lists+linux-bcache@lfdr.de>; Thu, 30 Jun 2022 09:36:36 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229844AbiF3Hgf (ORCPT <rfc822;lists+linux-bcache@lfdr.de>);
        Thu, 30 Jun 2022 03:36:35 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:57642 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232943AbiF3Hgb (ORCPT
        <rfc822;linux-bcache@vger.kernel.org>);
        Thu, 30 Jun 2022 03:36:31 -0400
Received: from smtp-out2.suse.de (smtp-out2.suse.de [195.135.220.29])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id BE4B53334B
        for <linux-bcache@vger.kernel.org>; Thu, 30 Jun 2022 00:36:30 -0700 (PDT)
Received: from imap2.suse-dmz.suse.de (imap2.suse-dmz.suse.de [192.168.254.74])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature ECDSA (P-521) server-digest SHA512)
        (No client certificate requested)
        by smtp-out2.suse.de (Postfix) with ESMTPS id 7E68A1F92C;
        Thu, 30 Jun 2022 07:36:29 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=suse.de; s=susede2_rsa;
        t=1656574589; h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
         mime-version:mime-version:content-type:content-type:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=JhnH9HwxOr2GMCJRX2mQ4Agg6iMLZPqtm2+/BiAj02I=;
        b=MBUcBJ2Z3XU+daOMXD2MQq3CUM53moaeVrc9Zgr6JHo01apfB3zK8+ERRrUTSr4vPl+/m8
        uGDFgvrgJ8DV1QEk04lo2cYzj46aHIhRXI6vVEUWnu0yynmNDg0GcyFaVKZi1u2Hh03Vx/
        icYoQVtnjQ7zT6Ouz135spQI4al51Ig=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=suse.de;
        s=susede2_ed25519; t=1656574589;
        h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
         mime-version:mime-version:content-type:content-type:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=JhnH9HwxOr2GMCJRX2mQ4Agg6iMLZPqtm2+/BiAj02I=;
        b=WpKz3arVVPEWkvZJlvy+affMYoXEeA6euMNCgfhL6nIy3B3yXcv8xK8cCj3BnXf5V0lldY
        PoeqhtTqd8lkyiDw==
Received: from imap2.suse-dmz.suse.de (imap2.suse-dmz.suse.de [192.168.254.74])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature ECDSA (P-521) server-digest SHA512)
        (No client certificate requested)
        by imap2.suse-dmz.suse.de (Postfix) with ESMTPS id E448213A5C;
        Thu, 30 Jun 2022 07:36:28 +0000 (UTC)
Received: from dovecot-director2.suse.de ([192.168.254.65])
        by imap2.suse-dmz.suse.de with ESMTPSA
        id bouNLXxSvWLDMwAAMHmgww
        (envelope-from <colyli@suse.de>); Thu, 30 Jun 2022 07:36:28 +0000
Content-Type: text/plain;
        charset=utf-8
Mime-Version: 1.0 (Mac OS X Mail 16.0 \(3696.100.31\))
Subject: Re: bcache I/O performance tests on 5.15.0-40-generic
From:   Coly Li <colyli@suse.de>
In-Reply-To: <CAC6jXv2u_0s-hvj4J4gurfoxgKNHFcHYq9F8cfcf-s6oG+pU+Q@mail.gmail.com>
Date:   Thu, 30 Jun 2022 15:36:26 +0800
Cc:     linux-bcache@vger.kernel.org
Content-Transfer-Encoding: quoted-printable
Message-Id: <E5629229-E51D-470F-9A6E-53434EF9F7FF@suse.de>
...
with 15GB cache device, if I write 12gb, it still slow down, so you do =
not get  "close to ssd" speed for such IO write.. even if its smaller =
than cache size.
> =20
...
I cannot tell why dmcache is so good from your performance number. But =
if the peak write speed is around 550MB/s, it may take around 20 =
seconds. What happens if the I/O testing may take longer, e.g. 1 hours?

BTW, people cannot get =E2=80=9Cclose to ssd=E2=80=9D speed on bcache, =
for each write/read I/O request, bcache will update B+tree index, cache =
data, write journal, and maybe split B+tree node, and the I/O procedure =
might be interfered by I/Os from gc and writeback. So it is good enough, =
but cannot be close to SSD speed.
