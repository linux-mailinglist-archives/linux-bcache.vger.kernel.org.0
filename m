...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 76F89699E14
	for <lists+linux-bcache@lfdr.de>; Thu, 16 Feb 2023 21:44:42 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229501AbjBPUol (ORCPT <rfc822;lists+linux-bcache@lfdr.de>);
        Thu, 16 Feb 2023 15:44:41 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:55540 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229460AbjBPUok (ORCPT
        <rfc822;linux-bcache@vger.kernel.org>);
        Thu, 16 Feb 2023 15:44:40 -0500
Received: from mx.ewheeler.net (mx.ewheeler.net [173.205.220.69])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B48614ECEF
        for <linux-bcache@vger.kernel.org>; Thu, 16 Feb 2023 12:44:39 -0800 (PST)
Received: from localhost (localhost [127.0.0.1])
        by mx.ewheeler.net (Postfix) with ESMTP id 5E4D04B;
        Thu, 16 Feb 2023 12:44:39 -0800 (PST)
X-Virus-Scanned: amavisd-new at ewheeler.net
Received: from mx.ewheeler.net ([127.0.0.1])
        by localhost (mx.ewheeler.net [127.0.0.1]) (amavisd-new, port 10024)
        with LMTP id GTMpQLlObiBH; Thu, 16 Feb 2023 12:44:35 -0800 (PST)
Received: from localhost (localhost [127.0.0.1])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mx.ewheeler.net (Postfix) with ESMTPSA id EB99F40;
        Thu, 16 Feb 2023 12:44:34 -0800 (PST)
DKIM-Filter: OpenDKIM Filter v2.11.0 mx.ewheeler.net EB99F40
Date:   Thu, 16 Feb 2023 12:44:34 -0800 (PST)
From:   Eric Wheeler <bcache@lists.ewheeler.net>
To:     Stefan Boehringer <me@s-boehringer.org>
cc:     Matthias Ferdinand <bcache@mfedv.net>, linux-bcache@vger.kernel.org
Subject: Re: bcache kernel panic
In-Reply-To: <23c21534-b729-113c-7ae2-14a8542a3311@s-boehringer.org>
Message-ID: <317f80-9ad6-4e81-2b4-8d9fe14223c0@ewheeler.net>
References: <54d572de-2d65-2a35-ae33-3a5a0cfe3db6@s-boehringer.org> <Y+5vKc/X+x9K/v0g@xoff> <23c21534-b729-113c-7ae2-14a8542a3311@s-boehringer.org>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="8323328-362921896-1676580274=:6562"
...
--8323328-362921896-1676580274=:6562
Content-Type: text/plain; charset=UTF-8
Content-Transfer-Encoding: 8BIT

On Thu, 16 Feb 2023, Stefan Boehringer wrote:
...
> (maybe usable via ssh, but haven't tried). I have to perform a hard 
> reset.

You might setup `netconsole` or a serial console to get the kernel's 
backtrace the moment it does a green screen.  For example:
  https://wiki.ubuntu.com/Kernel/Netconsole

Maybe that will provide more info.
...
> >> Feb 15 08:44:49.840860 myhost kernel: Code: 00 00 00 48 89 ee 48 c7 c2 70
> >> c4
> >> cb c0 48 c7 c7 a8 c4 cb c0 4c 89 5c 24 48 48 89 44 24 20 c6 05 21 c8 02 00
> >> 01 e8 3e f5 65 f1 <0f> 0b 4c 8b 5c 24 48 48 8b 44 24 20 e9 6b ff ff ff 44
> >> 8b
> >> 74 24 54
...
> >> Feb 15 08:44:49.841203 myhost kernel:  ?
