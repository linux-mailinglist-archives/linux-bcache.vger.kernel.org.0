...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 1A76955F805
	for <lists+linux-bcache@lfdr.de>; Wed, 29 Jun 2022 09:09:32 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232757AbiF2HFZ (ORCPT <rfc822;lists+linux-bcache@lfdr.de>);
        Wed, 29 Jun 2022 03:05:25 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:47048 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232763AbiF2HFK (ORCPT
        <rfc822;linux-bcache@vger.kernel.org>);
        Wed, 29 Jun 2022 03:05:10 -0400
Received: from mail-lf1-x133.google.com (mail-lf1-x133.google.com [IPv6:2a00:1450:4864:20::133])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C58D835ABA
        for <linux-bcache@vger.kernel.org>; Wed, 29 Jun 2022 00:03:14 -0700 (PDT)
Received: by mail-lf1-x133.google.com with SMTP id t24so26388532lfr.4
        for <linux-bcache@vger.kernel.org>; Wed, 29 Jun 2022 00:03:14 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=mime-version:references:in-reply-to:from:date:message-id:subject:to
         :cc:content-transfer-encoding;
        bh=WW9977k7WMyNM5OwSVLMGYa+iLOO4xPQNTMbFHOZhTI=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=WW9977k7WMyNM5OwSVLMGYa+iLOO4xPQNTMbFHOZhTI=;
        b=
X-Gm-Message-State: AJIora8IVizhZrz8KtQD4DuRrQSkVySkQFprgm+ewTeWjMDUJ8ilE0uU
        0QUJxVyRBY9aFFFVehgB2XoeNQugOohYNlqb3GUG4tCXeYyr7w==
X-Google-Smtp-Source: AGRyM1s/wspxXbEe2AXRNMbUpWbVbbl58bDv+0K/RytxrBxnPPnTa54/gvc7pO3u1vtXCH3XLltTTLyjpx0JQoTuZYE=
X-Received: by 2002:a05:6512:3ba0:b0:47f:664c:9e87 with SMTP id
 g32-20020a0565123ba000b0047f664c9e87mr1047773lfv.59.1656486192707; Wed, 29
 Jun 2022 00:03:12 -0700 (PDT)
MIME-Version: 1.0
...
In-Reply-To: <342D4E30-B29D-4C19-8DE5-90726F97282A@suse.de>
From:   Nikhil Kshirsagar <nkshirsagar@gmail.com>
Date:   Wed, 29 Jun 2022 12:32:59 +0530
Message-ID: <CAC6jXv1SvSQfjrCEX0R9gcYOuVO0AJSfcZoaW9gvSdCRr=Yfew@mail.gmail.com>
...
>
>
> > 2022=E5=B9=B46=E6=9C=8828=E6=97=A5 14:31=EF=BC=8CNikhil Kshirsagar <nks=
hirsagar@gmail.com> =E5=86=99=E9=81=93=EF=BC=9A
> >
> > Hi Coly,
> >
> > I just kicked off a 20gb random readwrite test using fio to a bcache de=
vice,
> >
> > fio --filename=3D/home/ubuntu/bcache_mount/cacahedfile --size=3D20GB
> > --direct=3D1 --rw=3Drandrw --bs=3D4k --ioengine=3Dlibaio --iodepth=3D12=
8
...
> >  =E2=94=94=E2=94=80bcache0 252:0    0    60G  0 disk /home/ubuntu/bcach=
e_mount
...
> >
> > [ 2782.176705] INFO: task kworker/2:1:255 blocked for more than 120 sec=
onds.
...
> > [ 2783.155385]  </TASK>
> > [ 2783.155423] INFO: task kworker/3:1:267 blocked for more than 121 sec=
onds.
...
> > [ 2784.133640]  </TASK>
> > [ 2784.133650] INFO: task kworker/25:2:326 blocked for more than 122 se=
conds.
...
> > [ 2785.114839]  </TASK>
> > [ 2785.114864] INFO: task kworker/6:0:3038 blocked for more than 123 se=
conds.
...
> > [ 2786.092081]  </TASK>
> > [ 2786.092088] INFO: task kworker/25:0:3047 blocked for more than 124 s=
econds.
...
> > 000000000000004a
> > [ 2789.014248] RAX: ffffffffffffffda RBX: 0000000000000000 RCX: 00007f2=
cfdcfea5b
> > [ 2789.014249] RDX: 0000000000000000 RSI: 000055c8d26e6f40 RDI: 0000000=
000000006
> > [ 2789.014250] RBP: 0000000000001000 R08: 0000000000000000 R09: 000055c=
8d26e6f40
> > [ 2789.014252] R10: 00000000a318c620 R11: 0000000000000293 R12: 00007f2=
cf38a7000
> > [ 2789.014253] R13: 0000000000000000 R14: 00007f2cfb0522f0 R15: 0000000=
500000000
> > [ 2789.014255]  </TASK>
> > [ 2909.151501] INFO: task kworker/2:1:255 blocked for more than 247 sec=
onds.
...
> > [ 2910.130305]  </TASK>
> > [ 2910.130307] INFO: task kworker/3:1:267 blocked for more than 248 sec=
onds.
...
> > [ 2911.104697]  </TASK>
> > [ 2911.104733] INFO: task kworker/25:2:326 blocked for more than 249 se=
conds.
...
> > [ 2912.087617]  </TASK>
> >
> > Is this a bug? It's in writeback mode. I'd setup the cache and run stuf=
f like,
> >
...
>
> Where do you get the kernel? If this is stable kernel, could you give me =
the HEAD commit id?
>
> Coly Li
>
