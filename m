...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 623BC2C54F9
	for <lists+linux-bcache@lfdr.de>; Thu, 26 Nov 2020 14:09:50 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2390057AbgKZNHt (ORCPT <rfc822;lists+linux-bcache@lfdr.de>);
        Thu, 26 Nov 2020 08:07:49 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:53230 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S2390038AbgKZNHq (ORCPT
        <rfc822;linux-bcache@vger.kernel.org>);
        Thu, 26 Nov 2020 08:07:46 -0500
Received: from casper.infradead.org (casper.infradead.org [IPv6:2001:8b0:10b:1236::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 123BCC061A04;
        Thu, 26 Nov 2020 05:07:46 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
        d=infradead.org; s=casper.20170209; h=Content-Transfer-Encoding:MIME-Version:
        References:In-Reply-To:Message-Id:Date:Subject:Cc:To:From:Sender:Reply-To:
        Content-Type:Content-ID:Content-Description;
        bh=CHJyFK5DnT0y5BHAvruGFTzdOzqciOqUVZYK0Q81OEM=; b=rYGFUhb/A4nrRcKK5PuIYkqMN9
        ;
Received: from [2001:4bb8:18c:1dd6:27b8:b8a1:c13e:ceb1] (helo=localhost)
        by casper.infradead.org with esmtpsa (Exim 4.92.3 #3 (Red Hat Linux))
        id 1kiGzo-0004DU-9d; Thu, 26 Nov 2020 13:07:37 +0000
...
Cc:     Tejun Heo <tj@kernel.org>, Josef Bacik <josef@toxicpanda.com>,
        ...
        linux-mm@kvack.org
Subject: [PATCH 43/44] block: merge struct block_device and struct hd_struct
Date:   Thu, 26 Nov 2020 14:04:21 +0100
Message-Id: <20201126130422.92945-44-hch@lst.de>
...
index b58595f2ca33b1..af76c2fff40d31 100644
--- a/block/genhd.c
+++ b/block/genhd.c
...
@@ -159,36 +160,6 @@ struct block_device *__disk_get_part(struct gendisk *disk, int partno)
...
@@ -846,7 +817,7 @@ void del_gendisk(struct gendisk *disk)
...
@@ -1162,24 +1133,22 @@ static ssize_t disk_ro_show(struct device *dev,
...
+		inflight = part_in_flight(bdev);
 	...
 	return sprintf(buf,
 		"%8lu %8lu %8llu %8u "
@@ -1214,14 +1183,14 @@ ssize_t part_stat_show(struct device *dev,
...
@@ -1269,16 +1238,14 @@ static DEVICE_ATTR(badblocks, 0644, disk_badblocks_show, disk_badblocks_store);
...
@@ -1492,7 +1459,7 @@ static int diskstats_show(struct seq_file *seqf, void *v)
...
@@ -1564,7 +1531,7 @@ dev_t blk_lookup_devt(const char *name, int partno)
 	class_dev_iter_init(&iter, &block_class, NULL, &disk_type);
 	while ((dev = class_dev_iter_next(&iter))) {
 		struct gendisk *disk = dev_to_disk(dev);
-		struct hd_struct *part;
+		struct block_device *part;
 		...
 		if (strcmp(dev_name(dev), name))
 			continue;
@@ -1577,13 +1544,12 @@ dev_t blk_lookup_devt(const char *name, int partno)
...
index 6cccb2f38adb24..deca253583bd3f 100644
...
index a15d1c114a247e..58fd6625966511 100644
--- a/fs/block_dev.c
+++ b/fs/block_dev.c
@@ -39,7 +39,6 @@
...
@@ -922,11 +918,6 @@ struct block_device *bdgrab(struct block_device *bdev)
 }
