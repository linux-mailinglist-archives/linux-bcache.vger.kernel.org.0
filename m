...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 61D4E179C7C
	for <lists+linux-bcache@lfdr.de>; Thu,  5 Mar 2020 00:35:19 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2388412AbgCDXfS (ORCPT <rfc822;lists+linux-bcache@lfdr.de>);
        Wed, 4 Mar 2020 18:35:18 -0500
Received: from mail.comune.nogara.vr.it ([46.21.176.248]:48973 "EHLO
        mail.comune.nogara.vr.it" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S2388407AbgCDXfS (ORCPT
        <rfc822;linux-bcache@vger.kernel.org>);
        Wed, 4 Mar 2020 18:35:18 -0500
Received: from localhost (localhost [127.0.0.1])
        by mail.comune.nogara.vr.it (Postfix) with ESMTP id 8C44CC6F54;
        Thu,  5 Mar 2020 00:30:43 +0100 (CET)
Received: from mail.comune.nogara.vr.it ([127.0.0.1])
        by localhost (mail.comune.nogara.vr.it [127.0.0.1]) (amavisd-new, port 10032)
        with ESMTP id ZDudJline2cZ; Thu,  5 Mar 2020 00:30:42 +0100 (CET)
Received: from localhost (localhost [127.0.0.1])
        by mail.comune.nogara.vr.it (Postfix) with ESMTP id C4561C6F50;
        Thu,  5 Mar 2020 00:30:41 +0100 (CET)
X-Virus-Scanned: amavisd-new at comune.nogara.vr.it
Received: from mail.comune.nogara.vr.it ([127.0.0.1])
        by localhost (mail.comune.nogara.vr.it [127.0.0.1]) (amavisd-new, port 10026)
        with ESMTP id TVuEwW7IFXFm; Thu,  5 Mar 2020 00:30:41 +0100 (CET)
Received: from mail.comune.nogara.vr.it (mail.comune.nogara.vr.it [192.168.35.12])
        by mail.comune.nogara.vr.it (Postfix) with ESMTP id 9F9BDC567E;
        Thu,  5 Mar 2020 00:30:40 +0100 (CET)
Date:   Thu, 5 Mar 2020 00:30:40 +0100 (CET)
...
Message-ID: <1577997526.223367.1583364640583.JavaMail.zimbra@comune.nogara.vr.it>
Subject: 
MIME-Version: 1.0
...
Thread-Topic: 
Thread-Index: cX697qsqD5eKbCoEPNNo0afcsCNFvg==
