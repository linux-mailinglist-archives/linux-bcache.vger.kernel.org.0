...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 9C22D5E5880
	for <lists+linux-bcache@lfdr.de>; Thu, 22 Sep 2022 04:20:49 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229630AbiIVCUr (ORCPT <rfc822;lists+linux-bcache@lfdr.de>);
        Wed, 21 Sep 2022 22:20:47 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:51520 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229658AbiIVCUq (ORCPT
        <rfc822;linux-bcache@vger.kernel.org>);
        Wed, 21 Sep 2022 22:20:46 -0400
Received: from mail-m31114.qiye.163.com (mail-m31114.qiye.163.com [103.74.31.114])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id CDF169DFA1
        for <linux-bcache@vger.kernel.org>; Wed, 21 Sep 2022 19:20:44 -0700 (PDT)
Received: from localhost.localdomain (unknown [218.94.118.90])
        by mail-m31114.qiye.163.com (Hmail) with ESMTPA id 0810D5C0187;
        Thu, 22 Sep 2022 10:20:41 +0800 (CST)
From:   mingzhe.zou@easystack.cn
To:     colyli@suse.de, linux-bcache@vger.kernel.org
Cc:     zoumingzhe@qq.com
Subject: [PATCH v4 1/3] bcache: bch_sectors_dirty_init() check each thread result and return error
Date:   Thu, 22 Sep 2022 10:20:39 +0800
Message-Id: <20220922022041.27183-1-mingzhe.zou@easystack.cn>
X-Mailer: git-send-email 2.17.1
X-HM-Spam-Status: e1kfGhgUHx5ZQUpXWQgPGg8OCBgUHx5ZQUlOS1dZFg8aDwILHllBWSg2Ly
        tZV1koWUFJQjdXWS1ZQUlXWQ8JGhUIEh9ZQVlDGUtCVh8dSE9DSENJGExOSlUZERMWGhIXJBQOD1
        lXWRgSC1lBWUlKQ1VCT1VKSkNVQktZV1kWGg8SFR0UWUFZT0tIVUpKS0hKTFVKS0tVS1kG
X-HM-Sender-Digest: e1kMHhlZQR0aFwgeV1kSHx4VD1lBWUc6Oio6KTo4MTIKMy4#HyIxSk8j
        DhcaCUhVSlVKTU1IQ0pISU9JQ05JVTMWGhIXVRYSFRwBEx5VARQOOx4aCAIIDxoYEFUYFUVZV1kS
        C1lBWUlKQ1VCT1VKSkNVQktZV1kIAVlBTkpNSjcG
X-HM-Tid: 0a8362ff4e1500c3kurm0810d5c0187
...
index 3f0ff3aab6f2..c21b1cddefdd 100644
...
@@ -934,9 +937,10 @@ static int bch_btre_dirty_init_thread_nr(void)
 	return n;
 }
