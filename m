...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id A26A138C098
	for <lists+linux-bcache@lfdr.de>; Fri, 21 May 2021 09:20:04 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233118AbhEUHV0 (ORCPT <rfc822;lists+linux-bcache@lfdr.de>);
        Fri, 21 May 2021 03:21:26 -0400
Received: from mga04.intel.com ([192.55.52.120]:16559 "EHLO mga04.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S230427AbhEUHVZ (ORCPT <rfc822;linux-bcache@vger.kernel.org>);
        Fri, 21 May 2021 03:21:25 -0400
IronPort-SDR: E3D8OCFcKrPQOC1Qb/h0Kegu1FTeGo/dSJX4bmLqGnPzITDA/X3H6ZHkNk0NeZrDzOqtAii15+
 EHxVzt07wx9w==
X-IronPort-AV: E=McAfee;i="6200,9189,9990"; a="199484327"
X-IronPort-AV: E=Sophos;i="5.82,313,1613462400"; 
   d="scan'208";a="199484327"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
  by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 21 May 2021 00:20:03 -0700
IronPort-SDR: rLs7U6N1CpzzTnx0M4AuvAqCl54AK29MjhChdbIVJrsDVWTCdDQNvBHdKBlugHZVC0YFZOMUbL
 xUyAiQ+Wv9Yg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.82,313,1613462400"; 
   d="scan'208";a="440817148"
Received: from ceph.sh.intel.com ([10.239.241.176])
  by orsmga008.jf.intel.com with ESMTP; 21 May 2021 00:20:01 -0700
...
Subject: [bch-nvm-pages v10 3/6] bcache: initialization of the buddy
Date:   Fri, 21 May 2021 10:57:23 -0400
Message-Id: <20210521145726.154276-4-qiaowei.ren@intel.com>
...
index 34e8a7c8a463..58c28b0779dd 100644
--- a/drivers/md/bcache/nvm-pages.c
+++ b/drivers/md/bcache/nvm-pages.c
@@ -32,6 +32,10 @@ static void release_nvm_namespaces(struct bch_nvm_set *nvm_set)
...
@@ -46,17 +50,130 @@ static void release_nvm_set(struct bch_nvm_set *nvm_set)
 	kfree(nvm_set);
 }
...
@@ -163,7 +280,7 @@ static int read_nvdimm_meta_super(struct block_device *bdev,
...
@@ -247,18 +364,49 @@ struct bch_nvm_namespace *bch_register_namespace(const char *dev_path)
 	ns->nvm_set = only_set;
 	mutex_init(&ns->lock);
...
index 1d62e9f0d4bf..dce013a90f37 100644
